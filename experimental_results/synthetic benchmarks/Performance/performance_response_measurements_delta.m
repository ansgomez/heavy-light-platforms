function aux = performance_response_measurements_delta(file, total_iterations, util_measurements, delta_measurements, frequency_measurements, sampling_rate, f_min)
