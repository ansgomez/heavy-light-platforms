...
single_core_response_file = 'openshoe_perf.xlsx';
performance_response_file = 'openshoe_perf_perf.xlsx';
energy_response_file = 'openshoe_energ_perf.xlsx';
...
response_energy(FREQUENCY_MEASUREMENTS) = response_performance(FREQUENCY_MEASUREMENTS);
util = 1;
delta = 1;

x_name = 'F_{LC} (MHz)';
y_name = 'Makespan Imprv. (%)';
title_name = sprintf('Openshoe Benchmark - Makespan');
