...
single_core_energy_file = 'flow_energ.xlsx';
performance_energy_file = 'flow_perf_energ.xlsx';
energy_energy_file = 'flow_energ_energ.xlsx';
...
title_name = sprintf('Flow Benchmark - Energy Savings');
